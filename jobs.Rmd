...
By completing this project, we are able to understand more in depth about the basic requirements and information on data - related job in California State. Based on the analysis, graphs are created to help visualizing the behavior of different variables in the data set, and functions are created to help searching the desired outputs that matches the conditional inputs.  
