...
jdata$Difficulty[which(jdata$Difficulty == "Easy"),]
...
length(Argu_x) %in% length(Argu_y)

Argu_x_empty = rep(0,length(Argu_x))
...
```{r}
model1 = lm(Estimate_minimum_average_salary ~ Posi_Bonus, data = jdata)
