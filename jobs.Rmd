...
The graph shows the frequency of top 5 most demanding language in California state. By calculating each language frequency, we conclude that Java, Python,R,SOL and C are top 5 most demanding language in California State. The frequency of each language is  subsetted by the north vs south region in California State and is indicated with color blue and red in the graph. The numbers on top of each bar indicate the frequency of different Language.
