...
```{r}
City_Eng = c("San Francisco","Santa Monica","Los Angeles")
City_Sci =c("San Francisco","Santa Monica","Los Angeles")

n_San_Eng = length(str_subset(Eng_sub$City, pattern = "San Francisco"))

```

```{r}
City_Data_fr = data.frame (City = rep(c("San Francisco","Santa Monica","Los Angeles"),each = 3),
                    Factor = c("Data Scienist","Data Engineer"),
                    Number = c()
