...
This graph shows the frequency of each factors in the standing variable of jdata set. Each factor is subsetted by region, which is north vs south in California state. The indepedent variables are bachelor degree, master degree and Ph.D, and the dependent variables is the frequency of the indepedent variables. The numbers on top of each bar indicates the frequency of that factor. The color indicates region difference.
