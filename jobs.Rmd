...
n_bach = length(str_subset(jdata$Standing, pattern = "^B")) + count(jdata$Standing)$freq[which(count(jdata$Standing) == "All levels")]

n_bach

n_master = length(str_subset(jdata$Standing, pattern = "^MS")) + length(str_subset(jdata$Standing, pattern = "MS$")) +  count(jdata$Standing)$freq[which(count(jdata$Standing) == "MBA")] + count(jdata$Standing)$freq[which(count(jdata$Standing) == "All levels")]
